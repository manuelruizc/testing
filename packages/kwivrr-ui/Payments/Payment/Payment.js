...
const paymentLogos = {
    ...
    square: 'https://www.tiendadeapps.com/wp-content/uploads/2020/04/cash-app.png',
};
...
function Payment({
    ...
    const { last4, paymentType, handler, brand, defaultOption, id, type } =
        paymentOption;
    const deleteItem = () => {
        openConfirmModal(
            [
    ...
    return (
        <View style={classes.container}>
                ...
                <View style={classes.touchablePayment}>
                    ...
                    >
                        <View style={classes.paymentContent}>
                            ...
                            {selected && selected === paymentOption.id && (
                                <View style={classes.defaultLabel}>
                                    <KwivrrIcon
                                        name="check"
                                        color="#55D38D"
            ...
            {deleteOption && (
                <TouchableOpacity
                    onPress={
                        customDeleteOption ? customDeleteOption : deleteItem
                    }
                >
...
Payment.propTypes = {
    ...
    deletePaymentOption: PropTypes.func.isRequired,
