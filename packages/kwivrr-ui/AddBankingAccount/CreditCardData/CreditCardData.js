...
function CreditCardData() {
    ...
    const [{ value: cardNumber }, , { setValue: setCardNumber }] = useField(
        'creditCard.cardNumber'
    );
    const [{ value: cardExpiration }, , { setValue: setCardExpiration }] =
        useField('creditCard.expiration');
    ...
    return (
        <>
            <View style={classes.inputs}>
                ...
                <InputComponent
                    usingFormikField
                    name="creditCard.addressLineOne"
                    style={classes.inputContainer}
                    inputStyle={classes.inputStyle}
                ...
                <InputComponent
                    usingFormikField
                    name="creditCard.addressLineTwo"
                    style={classes.inputContainer}
                    inputStyle={classes.inputStyle}
